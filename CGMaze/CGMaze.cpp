...
//Lets Create a VertexList from our Data


//float * test = b.getInterlacedData();
//puts("got interlaced");
//int * indizes = b.getIndexList();
//puts("got indizes");
//
//int dsize = b.getInterlacedDataSize();
//puts("got data size");
//int isize = b.getIndexListSize();
//puts("index list length");
